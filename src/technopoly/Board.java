...
public class Board {
    ...
    public Board() {
        ...
        squares.add(new GO("Funding Round", 1, 200, "GO"));
        ...
        squares.add(new Utility("Techcoin Mine", 14, 150, "Utility", 0, 30));
        ...
        squares.add(new Utility("Data Centre", 19, 150, "Utility", 0, 30));
